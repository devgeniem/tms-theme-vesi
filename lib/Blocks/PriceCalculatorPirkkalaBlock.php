...
/**
 * Class PriceCalculatorPirkkalaBlock
 *
 * @package TMS\Theme\Vesi\Blocks
 */
class PriceCalculatorPirkkalaBlock extends BaseBlock {
     ...
     * @var string
     */
    const NAME = 'price-calculator-pirkkala';
     ...
     * @var string
     */
    const KEY = 'price-calculator-pirkkala';
    ...
    public function __construct() {
        $this->title = 'Liittymislaskuri Pirkkala';
