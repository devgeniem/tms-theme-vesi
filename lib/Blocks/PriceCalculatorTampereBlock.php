...
/**
 * Class PriceCalculatorBlock
 *
 * @package TMS\Theme\Vesi\Blocks
 */
class PriceCalculatorTampereBlock extends BaseBlock {
     ...
     * @var string
     */
    const NAME = 'price-calculator-tampere';
     ...
     * @var string
     */
    const KEY = 'price-calculator-tampere';
    ...
    public function __construct() {
        $this->title = 'Liittymislaskuri Tampere';
