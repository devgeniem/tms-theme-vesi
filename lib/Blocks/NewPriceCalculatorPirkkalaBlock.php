...
/**
 * Class NewPriceCalculatorPirkkalaBlock
 *
 * @package TMS\Theme\Vesi\Blocks
 */
class NewPriceCalculatorPirkkalaBlock extends BaseBlock {
     ...
     * @var string
     */
    const NAME = 'new-price-calculator-pirkkala';
     ...
     * @var string
     */
    const KEY = 'new-price-calculator-pirkkala';
    ...
    public function __construct() {
        $this->title = 'Liittymislaskuri Pirkkala (alv 25.5%)';
