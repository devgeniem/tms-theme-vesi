 ...
 */
class NewPriceCalculatorPirkkalaFormatter implements \TMS\Theme\Base\Interfaces\Formatter {
    ...
    public function hooks() : void {
        add_filter(
            'tms/acf/block/new-price-calculator-pirkkala/data',
            [ $this, 'format' ]
        );
    }
