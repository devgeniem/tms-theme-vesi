 ...
 */
class PriceCalculatorTampereFormatter implements \TMS\Theme\Base\Interfaces\Formatter {
    ...
    public function hooks() : void {
        add_filter(
            'tms/acf/block/price-calculator-tampere/data',
            [ $this, 'format' ]
        );
    }
